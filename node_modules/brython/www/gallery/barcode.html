...
<style>
    ...
    input, div, h1 { width: 700px; margin: 25px; color: brown }
...
def render(event):
    ...
    if len(digits) % 2 != 0: return
    if [ digit for digit in digits if digit not in '0123456789' ]: return
