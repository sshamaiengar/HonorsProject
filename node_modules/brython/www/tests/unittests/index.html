...
sys.path.append(os.path.join(os.getcwd(), "Lib", "test"))
...
def choose_test(event):
    ...
    print(document["container"].children)
    sel = document['test']
...
document["btn_test"].bind('click', choose_test)
document["btn_show"].bind('click', show_test)
</script>
