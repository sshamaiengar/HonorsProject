...
<script type="text/javascript" src="../../src/py_import1.js"></script>
...
_a=VFS_import.VFSModuleFinder('/Lib')
_loader=_a.find_module('textwrap')
_loader.load_module()
""")
...
<a href="https://github.com/brython-dev/brython/issues">Issue Tracker</a></p>
