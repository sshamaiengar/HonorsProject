...
<body onload=brython() ><!-- remove the 1 to leave debug mode -->
    ...
    <script type="text/python3" src="console.py" id="__main__"></script>
    <details>
        <summary>Embed:</summary>
        <blockquote title="The Console can be embedded in a web page by adding this line">
            <pre>&lt;iframe src=http://brython.info/console.html width=800 height=400&gt;&lt;/iframe&gt;</pre>
        </blockquote>
    </details>
