...
<body onload="brython(1)">
    ...
    <div style="text-align:center">
        ...
        <br><a target="_blank" href="geo.html" title="by François Dion">geolocation</a>
        <br><a target="_blank" href="ruskey.html" title="by François Dion">Russian keyboard</a>
        <br><a target="_blank" href="kanban.html" title="by Pedro Rodriguez">pseudo Kanban simulator</a>
        <br><a target="_blank" href="battery.html" title="by Nicolas Pinault">battery load</a>
        <br><a target="_blank" href="barcode.html" title="by Carl Smith">barcode</a>
        ...
        <p><i><small>next examples require HTML5</small></i>
        <br><a target="_blank" href="clock.html">analog clock</a>
        <br><a target="_blank" href="europe.html">drag and drop</a>
        <br><a target="_blank" href="drop_files.html" title="by Glenn Linderman">drag and drop files</a>
        <!-- br><a target="_blank" href="sheet.html">local storage</a> -->
        <br><a target="_blank" href="canvas_plot.html" title="by Kiko Correoso">Python plot on the web</a>
        <br><a target="_blank" href="3Dwalker.html">3D walker</a>
        <br><a target="_blank" href="compass.html">compass (svg)</a>

        <br><a target="_blank" href="taquin.html">15-puzzle</a>
        ...
        <p><a target="_blank" href="three.html" title="by Dirk Krause">3D animation 3D with three.js</a>
        <p><a target="_blank" href="raphael">Raphael (vector graphics)</a>
        <p><a target="_blank" href="highcharts">Highcharts (interactive charts)</a>
